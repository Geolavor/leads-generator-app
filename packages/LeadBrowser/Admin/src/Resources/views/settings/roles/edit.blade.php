...
@section('content-wrapper')
    <div class="content full-page adjacent-center">
        {!! view_render_event('settings.roles.edit.header.before', ['role' => $role]) !!}
        ...
        {!! view_render_event('settings.roles.edit.header.after', ['role' => $role]) !!}

        <form method="POST" action="{{ route('settings.roles.update', ['id' => $role->id]) }}" @submit.prevent="onSubmit">
            <div class="page-content">
                <div class="form-container">
                    <div class="panel">
                        <div class="panel-header">
                            {!! view_render_event('settings.roles.edit.form_buttons.before', ['role' => $role]) !!}
                            ...
                            {!! view_render_event('settings.roles.edit.form_buttons.after', ['role' => $role]) !!}
                        </div>

                        <div class="panel-body">
                            {!! view_render_event('settings.roles.edit.form_controls.before', ['role' => $role]) !!}
                            ...
                            {!! view_render_event('settings.roles.edit.form_controls.after', ['role' => $role]) !!}
                        </div>
                    </div>
                </div>
            </div>

...
return [
    [
        ...
        "card_id"       => "top_search",
        "sort"          => 1,
        "card_type"     => "top_search_card",
        "data_class"    => "display-grid",
        "label"         => 'admin::app.dashboard.top_search',
    ],
    [
        "selected"      => true,
        "card_id"       => "leads",
        "sort"          => 2,
        "card_type"     => "bar_chart",
        // "view_url"      => "leads.index",
        "label"         => 'admin::app.dashboard.leads_over_time',
        // "class_name"    => "LeadBrowser\Admin\Helpers\DashboardHelper",

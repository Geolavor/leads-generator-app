...
@section('content-wrapper')
    <div class="content full-page adjacent-center">
        {!! view_render_event('settings.groups.edit.header.before', ['group' => $group]) !!}
        ...
        {!! view_render_event('settings.groups.edit.header.after', ['group' => $group]) !!}

        <form method="POST" action="{{ route('settings.groups.update', ['id' => $group->id]) }}" @submit.prevent="onSubmit">
            <div class="page-content">
                <div class="form-container">
                    <div class="panel">
                        <div class="panel-header">
                            {!! view_render_event('settings.groups.edit.form_buttons.before', ['group' => $group]) !!}
                            ...
                            {!! view_render_event('settings.groups.edit.form_buttons.after', ['group' => $group]) !!}
                        </div>

                        <div class="panel-body">
                            {!! view_render_event('settings.groups.edit.form_controls.before', ['group' => $group]) !!}
                            ...
                            {!! view_render_event('settings.groups.edit.form_controls.after', ['group' => $group]) !!}
                        </div>
                    </div>
                </div>
            </div>

const UPDATE_WELCOME_MODAL = (state) => {
...
const UPDATE_TABLE_ROW = (state, payload) => {
    state.tableData.records.data = state.tableData.records.data.map(data => {

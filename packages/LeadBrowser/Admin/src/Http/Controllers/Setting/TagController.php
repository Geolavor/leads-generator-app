...
class TagController extends Controller
{
     ...
     *
     * @var \LeadBrowser\User\Repositories\TagRepository
     */
    ...
    {
        if (request()->ajax()) {
            return app(\LeadBrowser\Admin\DataGrids\Setting\TagDataGrid::class)->toJson();
        }
    ...
    public function store()
    {
        if (request()->ajax()) {
            ...
            if ($validator->fails()) {
                session()->flash('warning', $validator->errors()->first('name'));

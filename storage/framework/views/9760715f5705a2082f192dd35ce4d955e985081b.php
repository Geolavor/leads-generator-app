            ...
            <div class="row justify-content-lg-between align-items-md-center">
                <div class="col-md-6 col-lg-5 mb-10 mb-md-0">
                    ...
                    <div class="d-grid d-sm-flex gap-3">
                        <a class="btn btn-primary btn-transition"href="<?php echo e(route('auth.register.create')); ?>">Get started</a>
                        <a class="btn btn-link"href="<?php echo e(route('auth.register.create')); ?>">Let's Talk <i class="bi-chevron-right small ms-1"></i></a>
                    </div>
                    ...
                    <div class="row justify-content-end">
                        <div class="col-3 mb-4">
                            ...
                            <div class="d-block avatar avatar-lg rounded-circle shadow-sm p-3 mt-n3 ms-5 aos-init aos-animate"
                                ...
                                <img class="avatar-img"
                                    src="<?php echo e(asset('vendor/leadBrowser/admin/assets/images/aws.svg')); ?>" alt="Image AWS">
                            </div>
                            <!-- End Logo -->
                        </div>
                        <div class="col-4 mb-4">
                            ...
                            <div class="d-block avatar avatar-xl rounded-circle shadow-sm p-4 mx-auto mt-5 aos-init aos-animate"
                                ...
                                <img class="avatar-img"
                                    src="<?php echo e(asset('vendor/leadBrowser/admin/assets/images/linkedin.svg')); ?>"
                                    alt="Image Linkedin">
                            </div>
                            <!-- End Logo -->
                        </div>
                        <div class="col-4 mb-4">
                            ...
                            <div class="d-block avatar avatar-xl rounded-circle shadow-sm p-4 ms-auto aos-init aos-animate"
                                ...
                                <img class="avatar-img"
                                    src="<?php echo e(asset('vendor/leadBrowser/admin/assets/images/rss.svg')); ?>" alt="Image RSS">
                            </div>
                            <!-- End Logo -->
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-3 offset-1 my-4">
                            ...
                            <div class="d-block avatar avatar-xl rounded-circle shadow-sm p-4 ms-auto aos-init aos-animate"
                                ...
                                <img class="avatar-img"
                                    src="<?php echo e(asset('vendor/leadBrowser/admin/assets/images/google.svg')); ?>"
                                    alt="Image Google">
                            </div>
                            <!-- End Logo -->
                        </div>
                        <div class="col-3 offset-2 my-4">
                            ...
                            <div class="d-block avatar avatar-xl rounded-circle shadow-sm p-4 ms-auto aos-init aos-animate"
                                ...
                                <img class="avatar-img"
                                    src="<?php echo e(asset('vendor/leadBrowser/admin/assets/images/facebook.svg')); ?>"
                                    alt="Image Facebook">
                            </div>
                            <!-- End Logo -->
                        </div>
                    ...
                    <div class="row d-none d-md-flex">
                        <div class="col-6">
                            ...
                            <div class="d-block avatar avatar-lg rounded-circle shadow-sm p-3 ms-auto aos-init aos-animate"
                                ...
                                <img class="avatar-img"
                                    src="<?php echo e(asset('vendor/leadBrowser/admin/assets/images/tesla.svg')); ?>"
                                    alt="Image Tesla">
                            </div>
                            <!-- End Logo -->
                        </div>
                        <div class="col-6 mt-6">
                            ...
                            <div class="d-block avatar avatar-xl rounded-circle shadow-sm p-4 ms-auto aos-init aos-animate"
                                ...
                                <img class="avatar-img"
                                    src="<?php echo e(asset('vendor/leadBrowser/admin/assets/images/hp.svg')); ?>" alt="Image HP">
                            </div>
                            <!-- End Logo -->
                        </div>
                    </div>
            ...
            <div class="position-relative overflow-hidden">
                <div class="row justify-content-lg-between">
                    <div class="col-md-4 py-5 pb-md-10">
                        ...
                        <a class="btn btn-outline-primary" href="<?php echo e(route('auth.register.create')); ?>">Sign up
                            today</a>
                    </div>
                    <!-- End Col -->
                            ...
                            <figure class="device-browser-frame rotated-3d-left">
                                <div class="device-browser-frame">
                                    <img class="device-browser-img"
                                        src="<?php echo e(asset('vendor/leadBrowser/admin/assets/images/screen.png')); ?>"
            ...
            <div class="container-fluid px-lg-6">
                <div class="row justify-content-center">
                    <div class="col-3 my-4">
                        <div class="d-none d-md-block avatar avatar-xl rounded-circle shadow-sm p-4 mx-auto">
                            <img class="avatar-img" src="<?php echo e(asset('vendor/leadBrowser/admin/assets/images/hp.svg')); ?>"
                                alt="Logo">
                        </div>
                    </div>
                    <!-- End Col -->
                    ...
                    <div class="col-3 mb-4">
                        <div class="d-block avatar avatar-xl rounded-circle shadow-sm p-4 mx-auto">
                            <img class="avatar-img" src="<?php echo e(asset('vendor/leadBrowser/admin/assets/images/aws.svg')); ?>"
                                alt="Logo">
                        </div>
                    </div>
                    <!-- End Col -->
                    ...
                    <div class="col-3 my-4">
                        <div class="d-none d-md-block avatar avatar-xl rounded-circle shadow-sm p-4 mx-auto">
                            <img class="avatar-img"
                                src="<?php echo e(asset('vendor/leadBrowser/admin/assets/images/facebook.svg')); ?>" alt="Logo">
                        </div>
                    </div>
                    <!-- End Col -->
                </div>
                ...
                <div class="row">
                    <div class="col-3 offset-1 my-4">
                        <div class="d-none d-md-block avatar avatar-xl rounded-circle shadow-sm p-4 ms-auto">
                            <img class="avatar-img" src="<?php echo e(asset('vendor/leadBrowser/admin/assets/images/tesla.svg')); ?>"
                                alt="Logo">
                        </div>
                    </div>
                    <!-- End Col -->
                ...
                <div class="row justify-content-between">
                    <div class="col-4">
                        <div class="d-block avatar avatar-xl rounded-circle shadow-sm p-4 mx-auto">
                            <img class="avatar-img"
                                src="<?php echo e(asset('vendor/leadBrowser/admin/assets/images/google.svg')); ?>" alt="Logo">
                        </div>
                    </div>
                    <!-- End Col -->
...
<?php echo $__env->make('admin::layouts.landing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mariusz/Desktop/leadbrowser/app/packages/LeadBrowser/Admin/src/resources/views/landing/index.blade.php ENDPATH**/ ?>
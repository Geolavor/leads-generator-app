{!! view_render_event('leads.view.informations.stages.before', ['lead' => $lead]) !!}

<stage-component></stage-component>

{!! view_render_event('leads.view.informations.stages.after', ['lead' => $lead]) !!}
...
@push('scripts')
    <script type="text/x-template" id="stage-component-template">
        <div>
            ...
            <form action="{{ route('leads.update', $lead->id) }}" method="post" data-vv-scope="change-stage-form">
        ...
        Vue.component('stage-component', {
            ...
            methods: {
                changeStage: function(stage) {
                    ...
                    this.$http.put("{{ route('leads.update', $lead->id) }}", {'lead_pipeline_stage_id': stage.id})

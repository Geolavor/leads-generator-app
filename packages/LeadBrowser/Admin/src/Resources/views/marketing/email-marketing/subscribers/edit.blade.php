...
@section('content-wrapper')
    ...
    <div class="content">
        <form method="POST" action="{{ route('customers.subscribers.update', $subscriber->id) }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
            <div class="page-header">
                <div class="page-title">
                    <h1>
                        <i class="icon angle-left-icon back-link" onclick="window.location = '{{ route('customers.subscribers.index') }}'"></i>
            ...
            <div class="form-group" :class="[errors.has('is_subscribed') ? 'has-error' : '']">

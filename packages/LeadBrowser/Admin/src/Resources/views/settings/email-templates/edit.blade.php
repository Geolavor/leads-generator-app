...
@section('content-wrapper')
    <div class="content full-page adjacent-center">
        {!! view_render_event('settings.email_templates.edit.header.before', ['emailTemplate' => $emailTemplate]) !!}
        ...
        {!! view_render_event('settings.email_templates.edit.header.after', ['emailTemplate' => $emailTemplate]) !!}

        <form method="POST" action="{{ route('settings.email_templates.update', ['id' => $emailTemplate->id]) }}" @submit.prevent="onSubmit">
            <div class="page-content">
                <div class="form-container">
                    <div class="panel">
                        <div class="panel-header">
                            {!! view_render_event('settings.email_templates.edit.form_buttons.before', ['emailTemplate' => $emailTemplate]) !!}
                            ...
                            {!! view_render_event('settings.email_templates.edit.form_buttons.after', ['emailTemplate' => $emailTemplate]) !!}
                        </div>

                        <div class="panel-body">
                            {!! view_render_event('settings.email_templates.edit.form_controls.before', ['emailTemplate' => $emailTemplate]) !!}
                            ...
                            {!! view_render_event('settings.email_templates.edit.form_controls.after', ['emailTemplate' => $emailTemplate]) !!}
                        </div>
                    </div>
                </div>
            </div>

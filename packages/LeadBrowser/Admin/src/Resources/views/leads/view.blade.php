...
@section('content-wrapper')
    ...
    <div class="content full-page">
        ...
        {!! view_render_event('leads.view.header.before', ['lead' => $lead]) !!}
        ...
        {!! view_render_event('leads.view.header.after', ['lead' => $lead]) !!}


        {!! view_render_event('leads.view.informations.before', ['lead' => $lead]) !!}

        <div class="page-content lead-view">

            <div class="lead-content-left">
                {!! view_render_event('leads.view.informations.details.before', ['lead' => $lead]) !!}
                    ...
                    <div class="panel-body" style="position: relative">
                        ...
                        @else
                            <div class="empty-record">
                                <img src="{{ asset('vendor/leadBrowser/admin/assets/images/empty-table-icon.svg') }}">
                ...
                {!! view_render_event('leads.view.informations.products.after', ['lead' => $lead]) !!}
            </div>
        ...
        {!! view_render_event('leads.view.informations.after', ['lead' => $lead]) !!}
    </div>
...
@push('scripts')
    ...
    <script type="text/x-template" id="edit-lead-form-template">
        <form action="{{ route('leads.update', $lead->id) }}" method="post" @submit.prevent="onSubmit" enctype="multipart/form-data">
            <modal id="updateLeadModal" :is-open="$root.modalIds.updateLeadModal">
                <h3 slot="header-title">{{ __('admin::app.leads.edit-title') }}</h3>

                <div slot="header-actions">
                    {!! view_render_event('leads.view.edit.form_buttons.before', ['lead' => $lead]) !!}
                    ...
                    {!! view_render_event('leads.view.edit.form_buttons.after', ['lead' => $lead]) !!}
                </div>

                <div slot="body">
                    {!! view_render_event('leads.view.edit.form_controls.before', ['lead' => $lead]) !!}
                    ...
                    <tabs>
                        {!! view_render_event('leads.view.edit.form_controls.details.before', ['lead' => $lead]) !!}
                        ...
                        {!! view_render_event('leads.view.edit.form_controls.products.after', ['lead' => $lead]) !!}
                    </tabs>

                    {!! view_render_event('leads.view.edit.form_controls.after', ['lead' => $lead]) !!}
                </div>
            </modal>
        </form>
    </script>

...
@section('content-wrapper')
    <div class="content full-page adjacent-center">
        {!! view_render_event('settings.pipelines.edit.header.before', ['pipeline' => $pipeline]) !!}
        ...
        {!! view_render_event('settings.pipelines.edit.header.after', ['pipeline' => $pipeline]) !!}

        <form method="POST" action="{{ route('settings.pipelines.update', $pipeline->id) }}" @submit.prevent="onSubmit">
            <div class="page-content">
                <div class="form-container">
                    <div class="panel">
                        <div class="panel-header">
                            {!! view_render_event('settings.pipelines.edit.form_buttons.before', ['pipeline' => $pipeline]) !!}
                            ...
                            {!! view_render_event('settings.pipelines.edit.form_buttons.after', ['pipeline' => $pipeline]) !!}
                        </div>

                        <div class="panel-body">
                            {!! view_render_event('settings.pipelines.edit.form_controls.before', ['pipeline' => $pipeline]) !!}
                            ...
                            {!! view_render_event('settings.pipelines.edit.form_controls.after', ['pipeline' => $pipeline]) !!}
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
    <script type="text/x-template" id="stages-component-template">
        <div class="table dragable-container">
            ...
            <button type="button" class="btn btn-primary mt-20" @click="addStage">

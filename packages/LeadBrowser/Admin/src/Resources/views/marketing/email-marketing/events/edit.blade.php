...
@section('content-wrapper')
    <div class="content">
        ...
        <form method="POST" action="{{ route('events.update', $event->id) }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
            <div class="page-header">
                <div class="page-title">
                    <h1>
                        <i class="icon angle-left-icon back-link" onclick="window.location = '{{ route('events.index') }}'"></i>
            ...
            <div class="page-content">
                <div class="form-container">
                    ...
                    {!! view_render_event('marketing.events.create.before') !!}
                    ...
                    {!! view_render_event('marketing.events.create.after') !!}

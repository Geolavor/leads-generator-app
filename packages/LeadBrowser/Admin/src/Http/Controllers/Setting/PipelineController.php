...
use LeadBrowser\Admin\Http\Requests\PipelineForm;
...
class PipelineController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return app(\LeadBrowser\Admin\DataGrids\Setting\PipelineDataGrid::class)->toJson();
        }
    ...
    public function store(PipelineForm $request)
    {
        ...
        // TODO: Change all to validated (all is a wrong way)

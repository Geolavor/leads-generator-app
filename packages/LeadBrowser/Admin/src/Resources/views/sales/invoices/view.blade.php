...
@section('content-wrapper')
    ...
    <div class="content full-page">
        <div class="page-header">
            ...
            <div class="page-action">
                ...
                <a href="{{ route('sales.invoices.print', $invoice->id) }}" class="btn btn-lg btn-primary">
        ...
        <div class="page-content">
            <tabs>
                ...
                <tab name="{{ __('admin::app.sales.transactions.title') }}" :selected="false">
                    <div class="sale-container">
                        <table-component data-src="{{ route('sales.invoices.transactions', $invoice->id) }}"></table-component>
                    </div>
                </tab>
            </tabs>
        </div>
    ...
    <modal id="duplicateInvoiceFormModal" :is-open="modalIds.duplicateInvoiceFormModal">
        ...
        <div slot="body">
            <form
                method="POST"
                action="{{ route('sales.invoices.send-duplicate-invoice', $invoice->id) }}"
                @submit.prevent="onSubmit">
                @csrf()

                <div class="control-group" :class="[errors.has('email') ? 'has-error' : '']">
                    <label for="email" class="required">{{ __('admin::app.emails.email') }}</label>
                    ...
                    <input
                        ...
                        type="email"
                        name="email"
                        data-vv-as="&quot;{{ __('admin::app.emails.email') }}&quot;"

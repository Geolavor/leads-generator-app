...
namespace LeadBrowser\Sales\Traits;
...
trait PaymentTerm
{
    ...
    public function getFormattedPaymentTerm()
    {
        ...
        if ($dueDuration > 1) {
            return __('admin::app.system.due-duration-days', ['due-duration' => $dueDuration]);
        }

        return $dueDuration
            ? __('admin::app.system.due-duration-day', ['due-duration' => $dueDuration])
            : __('admin::app.system.due-duration-day', ['due-duration' => 0]);
    }
}

...
@section('content-wrapper')
    @php
        $quote = app('\LeadBrowser\Quote\Repositories\QuoteRepository')->getModel();
    ...
    <div class="content full-page adjacent-center">
        ...
        <form method="POST" action="{{ route('quotes.store') }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
                ...
                <div class="form-container">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            {!! view_render_event('quotes.create.form_controls.information.before') !!}
                            ...
                            {!! view_render_event('quotes.create.form_controls.information.after') !!}


                            {!! view_render_event('quotes.create.form_controls.address.before') !!}
                            ...
                            {!! view_render_event('quotes.create.form_controls.address.after') !!}


                            {!! view_render_event('quotes.create.form_controls.items.before') !!}
                            ...
                            {!! view_render_event('quotes.create.form_controls.items.after') !!}

                            {!! view_render_event('quotes.create.form_controls.after') !!}
                        </div>
                    </div>

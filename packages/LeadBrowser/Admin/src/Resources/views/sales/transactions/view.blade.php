    ...
    <div class="content full-page">
        <div class="page-header">
            <div class="page-title">
                <h1>
                    <i class="icon angle-left-icon back-link" onclick="window.location = '{{ route('sales.transactions.index') }}'"></i>
                            ...
                            <div class="sale-section" style="width:100%">
                                ...
                                <div class="section-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <span class="value">
                                            <a href="{{ route('sales.orders.view', $transaction->order_id)}}">
                                    ...
                                    <div class="row">
                                        ...
                                        <span class="value">
                                            <a href="{{ route('sales.invoices.view', $transaction->invoice_id)}}">
...
@push('scripts')
    <!-- <script>
        ...
        channel.bind('created', function(data) {
            ...
            // vm.pushToTableData(data.search)
        });
        channel.bind('updated', function(data) {
            // consoel.log(data)
            // window.location.realod()
            // vm.updateTableRow(data.search)
        });
    </script> -->
@endpush
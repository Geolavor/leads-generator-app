...
namespace LeadBrowser\API\Http\Controllers\V1;

use LeadBrowser\Core\Eloquent\Repository;
use LeadBrowser\API\Http\Controllers\RestApiController;
...
class Controller extends RestApiController
{
     ...
     *
     * @param  \LeadBrowser\Core\Eloquent\Repository  $repository

<template>
    <div class="table">
        ...
        <div class="table table-body" v-if="Object.keys(tableData).length > 0">
            ...
            <div class="empty-table" v-else>
                ...
                <div v-else>
                    <img
                        :src="
                            `${baseURL}/vendor/leadBrowser/admin/assets/images/empty-table-icon.svg`
                        "
                    />
...
export default {
    ...
    mounted: function() {
        ...
        // var pusher = new Pusher('81ca621e2e0c2d59b577', {
        //     cluster: 'eu'
        // });

        // let vm = this
        // var channel = pusher.subscribe('result');
        // channel.bind('created', function(data) {
        //     vm.pushToTableData(data.result)
        // });
    },

    methods: {
        ...mapActions(["updateTableData", "pushToTableData", "updateTableRow", "toggleSidebarFilter"]),

...
@section('content-wrapper')
    <div class="content full-page adjacent-center">
        {!! view_render_event('settings.workflows.create.header.before') !!}
        ...
        {!! view_render_event('settings.workflows.create.header.after') !!}

        <form method="POST" action="{{ route('settings.workflows.store') }}" @submit.prevent="onSubmit">
            <div class="page-content">
                <div class="form-container">
                    <div class="panel">
                        <div class="panel-header">
                            {!! view_render_event('settings.workflows.create.form_buttons.before') !!}
                            ...
                            {!! view_render_event('settings.workflows.create.form_buttons.after') !!}
                        </div>

                        <div class="panel-body workflow-container">
                            {!! view_render_event('settings.workflows.create.form_controls.before') !!}

                            @csrf()

                            <workflow-component></workflow-component>

                            {!! view_render_event('settings.workflows.create.form_controls.after') !!}
                        </div>
                    </div>
                </div>
            </div>

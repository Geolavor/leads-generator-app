{!! view_render_event('leads.view.informations.activity_list.before', ['lead' => $lead]) !!}

<activity-list-component></activity-list-component>

{!! view_render_event('leads.view.informations.activity_list.after', ['lead' => $lead]) !!}

@push('scripts')

    <script type="text/x-template" id="activity-list-component-template">
        <tabs class="activity-list">
            {!! view_render_event('leads.view.informations.activity_list.general.before', ['lead' => $lead]) !!}
                    ...
                    >
                        ...
                        <template v-if="activity.type != 'email'">
                                ...
                                <div class="dropdown-list">
                                    <div class="dropdown-container">
                                        <ul>
                                            ...
                                            @if (bouncer()->hasPermission('crm.activities.edit'))
                                                <li>
                                                    <a :href="'{{ route('activities.edit') }}/' + activity.id" target="_blank">
                                                        {{ __('admin::app.leads.edit') }}
                                                    </a>
                                                </li>
                                            @endif

                                            @if (bouncer()->hasPermission('crm.activities.delete'))
                            ...
                            <div class="attachment" v-if="activity.file">
                                ...
                                <a :href="'{{ route('activities.file_download') }}/' + activity.file.id" target="_blank">
                                    @{{ activity.file.name }}
                                </a>
                            </div>
                                    ...
                                    <div class="dropdown-container">
                                        <ul>
                                            @if (bouncer()->hasPermission('mail.view'))
                                                <li>
                                                    <a :href="'{{ route('mail.view') }}/' + activity.folders[0] + '/' + activity.id" target="_blank">
            ...
            {!! view_render_event('leads.view.informations.activity_list.general.after', ['lead' => $lead]) !!}


            {!! view_render_event('leads.view.informations.activity_list.quotes.before', ['lead' => $lead]) !!}

            @if (bouncer()->hasPermission('crm.quotes'))
                <tab name="Quotes">
                                ...
                                <tr v-for="quote in quotes">
                                    ...
                                    <td class="actions">
                                        ...
                                        <div class="dropdown-list">
                                            <div class="dropdown-container">
                                                <ul>
                                                    @if (bouncer()->hasPermission('crm.quotes.edit'))
                                                        <li>
                                                    ...
                                                    @if (bouncer()->hasPermission('crm.quotes.print'))
                                                        <li>
                                                    ...
                                                    @if (bouncer()->hasPermission('crm.quotes.delete'))
            ...
            {!! view_render_event('leads.view.informations.activity_list.quotes.after', ['lead' => $lead]) !!}
        </tabs>
    </script>
    ...
    <script>
        Vue.component('activity-list-component', {
            ...
            data: function () {
                return {
                    activities: @json(app('\LeadBrowser\Lead\Repositories\LeadRepository')->getAllActivities($lead->id)),
            ...
            methods: {
                ...
                markAsDone: function(activity) {
                    ...
                    this.$http.put("{{ route('activities.update') }}/" + activity['id'], {'is_done': 1})
                ...
                remove: function(activity) {
                    ...
                    this.$http.delete("{{ route('activities.delete') }}/" + activity['id'])
                        .then (function(response) {
                            self.$root.pageLoaded = true;
                ...
                removeQuote: function(quote) {
                    ...
                    this.$http.delete("{{ route('leads.quotes.delete', $lead->id) }}/" + quote['id'])
                        .then (function(response) {
                            self.$root.pageLoaded = true;
                ...
                unlinkEmail: function(activity) {
                    ...
                    this.$http.put("{{ route('mail.update') }}/" + unlinkEmailid, {
                            'lead_id': null
                        })
                        .then (response => {
                            self.$root.pageLoaded = true;

...
@section('content-wrapper')
    <div class="content">
        ...
        <form method="POST" action="{{ route('campaigns.store') }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
            <div class="page-header">
                <div class="page-title">
                    <h1>
                        <i class="icon angle-left-icon back-link" onclick="window.location = '{{ route('customer.review.index') }}'"></i>

...
@section('content-wrapper')
    <div class="content">
        ...
        <form method="POST" action="{{ route('sitemaps.update', $sitemap->id) }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
            ...
            <div class="page-content">
                <div class="form-container">
                    ...
                    {!! view_render_event('marketing.sitemaps.update.before') !!}
                    ...
                    {!! view_render_event('marketing.sitemaps.update.after') !!}

        ...
        <div class="page-header">
            ...
            <div class="page-title">
                <h1>
                    ...
                    <i class="icon angle-left-icon back-link" onclick="window.location = '{{ route("sales.orders.index") }}'"></i>
            ...
            <div class="page-action">
                ...
                @if ($order->canCancel() && bouncer()->hasPermission('sales.orders.cancel'))
                    <a href="{{ route('sales.orders.cancel', $order->id) }}" class="btn btn-lg btn-primary" v-alert:message="'{{ __('admin::app.sales.orders.cancel-confirm-msg') }}'">
                        {{ __('admin::app.sales.orders.cancel-btn-title') }}
                    </a>
                @endif

                @if ($order->canInvoice() && $order->payment->method !== 'paypal_standard')
                    <a href="{{ route('sales.invoices.create', $order->id) }}" class="btn btn-lg btn-primary">
                        {{ __('admin::app.sales.orders.invoice-btn-title') }}
                    </a>
                @endif

                @if ($order->canRefund())
                    <a href="{{ route('sales.refunds.create', $order->id) }}" class="btn btn-lg btn-primary">
                            ...
                            <div slot="body">
                                ...
                                <div class="summary-comment-container">
                                    <div class="comment-container">
                                        <form action="{{ route('sales.orders.comment', $order->id) }}" method="post" @submit.prevent="onSubmit">
                                            @csrf()
                            ...
                            <tbody>
                                @foreach ($order->invoices as $invoice)
                                    <tr>
                                        ...
                                        <td class="action">
                                            <a href="{{ route('sales.invoices.view', $invoice->id) }}">
                            ...
                            <tbody>
                                ...
                                @foreach ($order->refunds as $refund)
                                    <tr>
                                        ...
                                        <td class="action">
                                            <a href="{{ route('sales.refunds.view', $refund->id) }}">
                                                <i class="icon eye-icon"></i>
                                            </a>
                                        </td>
                                    </tr>
                            ...
                            <tbody>
                                ...
                                @foreach ($order->transactions as $transaction)
                                    <tr>
                                        ...
                                        <td class="action">
                                            <a href="{{ route('sales.transactions.view', $transaction->id) }}">
                                                <i class="icon eye-icon"></i>
                                            </a>
                                        </td>
                                    </tr>

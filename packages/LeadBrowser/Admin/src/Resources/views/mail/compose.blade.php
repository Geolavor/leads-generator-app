...
@section('content-wrapper')
    <div class="content full-page adjacent-center">
        ...
        {!! view_render_event('mail.compose.header.before', ['email' => $email ?? null]) !!}
        ...
        {!! view_render_event('mail.compose.header.after', ['email' => $email ?? null]) !!}
...
@push('scripts')
    ...
    <script type="text/x-template" id="email-form-template">
        <form
            action="{{ isset($email) ? route('mail.update', $email->id) : route('mail.store') }}"
            method="POST"
            ...
            <div class="form-container">
                ...
                <div class="panel">
                    <div class="panel-header">
                        {!! view_render_event('mail.compose.form_buttons.before', ['email' => $email ?? null]) !!}

                        <button type="submit" class="btn btn-primary" @click="is_draft = 0">
                        ...
                        <a href="{{ route('mail.index', ['route' => 'inbox']) }}">{{ __('admin::app.mail.back') }}</a>

                        {!! view_render_event('mail.compose.form_buttons.after', ['email' => $email ?? null]) !!}
                    </div>
    
                    <div class="panel-body">
                        {!! view_render_event('mail.compose.form_controls.before', ['email' => $email ?? null]) !!}
                        ...
                        {!! view_render_event('mail.compose.form_controls.after', ['email' => $email ?? null]) !!}
                    </div>
                </div>

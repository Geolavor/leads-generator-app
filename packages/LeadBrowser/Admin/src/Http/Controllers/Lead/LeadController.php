...
class LeadController extends Controller
{
    ...
    public function get()
    {
        if (request('view_type')) {
            return app(\LeadBrowser\Admin\DataGrids\Lead\LeadDataGrid::class)->toJson();
        } else {
     ...
     *
     * @param \LeadBrowser\Admin\Http\Requests\LeadForm $request
     * @return \Illuminate\Http\Response
     */

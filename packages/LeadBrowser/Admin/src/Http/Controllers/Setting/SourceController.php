...
use LeadBrowser\Lead\Repositories\SourceRepository;
...
class SourceController extends Controller
{
     ...
     *
     * @var \LeadBrowser\User\Repositories\SourceRepository
     */
     ...
     *
     * @param  \LeadBrowser\Lead\Repositories\SourceRepository  $sourceRepository
     * @return void
     */
    ...
    {
        if (request()->ajax()) {
            return app(\LeadBrowser\Admin\DataGrids\Setting\SourceDataGrid::class)->toJson();
        }
    ...
    public function store()
    {
        ...
        if ($validator->fails()) {
            session()->flash('warning', trans('admin::app.settings.sources.name-exists'));
        ...
        return redirect()->route('settings.sources.index');
    }

...
@section('content-wrapper')
    <div class="content full-page adjacent-center">
        {!! view_render_event('settings.email_templates.create.header.before') !!}
        ...
        {!! view_render_event('settings.email_templates.create.header.after') !!}

        <form method="POST" action="{{ route('settings.email_templates.store') }}" @submit.prevent="onSubmit">
            <div class="page-content">
                <div class="form-container">
                    <div class="panel">
                        <div class="panel-header">
                            {!! view_render_event('settings.email_templates.create.form_buttons.before') !!}
                            ...
                            {!! view_render_event('settings.email_templates.create.form_buttons.after') !!}
                        </div>

                        <div class="panel-body">
                            {!! view_render_event('settings.email_templates.create.form_controls.before') !!}
                            ...
                            {!! view_render_event('settings.email_templates.create.form_controls.after') !!}
                        </div>
                    </div>
                </div>
            </div>

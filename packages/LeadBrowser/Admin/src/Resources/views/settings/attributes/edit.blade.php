...
@section('content-wrapper')
    <div class="content full-page adjacent-center">
        {!! view_render_event('settings.attributes.edit.header.before', ['attribute' => $attribute]) !!}
        ...
        {!! view_render_event('settings.attributes.edit.header.after', ['attribute' => $attribute]) !!}

        <form method="POST" action="{{ route('settings.attributes.update', $attribute->id) }}" @submit.prevent="onSubmit">
                ...
                <div class="form-container">
                    ...
                    <div class="panel">
                        <div class="panel-header">
                            {!! view_render_event('settings.attributes.edit.form_buttons.before', ['attribute' => $attribute]) !!}

                            <button type="submit" class="btn btn-primary">
                                {{ __('admin::app.settings.attributes.save-btn-title') }}
                            </button>

                            <a href="{{ route('settings.attributes.index') }}">{{ __('admin::app.settings.attributes.back') }}</a>

                            {!! view_render_event('settings.attributes.edit.form_buttons.after', ['attribute' => $attribute]) !!}
                        </div>

                        <div class="panel-body">
                            {!! view_render_event('settings.attributes.edit.form_controls.before', ['attribute' => $attribute]) !!}
                            ...
                            {!! view_render_event('settings.attributes.edit.form_controls.after', ['attribute' => $attribute]) !!}
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="form-group dragable-container">
            <template v-if="typeValue != 'lookup'">
                ...
                <template v-if="optionType == 'options'">
                    ...
                    <button type="button" class="btn btn-primary mt-20" id="add-option-btn" @click="addOptionRow">

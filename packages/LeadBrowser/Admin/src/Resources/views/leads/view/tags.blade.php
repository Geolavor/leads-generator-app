{!! view_render_event('leads.view.header.tags.before', ['lead' => $lead]) !!}

<tags-component></tags-component>

{!! view_render_event('leads.view.header.tags.after', ['lead' => $lead]) !!}
        ...
        Vue.component('tags-component', {
            ...
            methods: {
                ...
                addTag: function(tag) {
                    ...
                    self.$http.post(`{{ route('leads.tags.store', $lead->id) }}`, tag)
                        .then(response => {
                ...
                removeTag: function(tag) {
                    ...
                    this.$http.delete("{{ route('leads.tags.delete', $lead->id) }}/" + tag['id'])
                        .then (function(response) {

 ...
 * Partials components
 */
Vue.component('welcome-modal', require('./components/partials/welcome-modal.vue').default);
Vue.component('faq-list', require('./components/partials/faq-list.vue').default);
Vue.component('card-payment', require('./components/partials/card-payment.vue').default);
Vue.component('pricing-cards', require('./components/partials/pricing-cards.vue').default);
Vue.component('pricing-box', require('./components/partials/pricing-box.vue').default);

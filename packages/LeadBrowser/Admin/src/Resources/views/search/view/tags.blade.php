{!! view_render_event('searches.view.header.tags.before', ['search' => $search]) !!}

<tags-component></tags-component>

{!! view_render_event('searches.view.header.tags.after', ['search' => $search]) !!}
        ...
        Vue.component('tags-component', {
            ...
            methods: {
                ...
                addTag: function(tag) {
                    ...
                    self.$http.post(`{{ route('search.tags.store', $search->id) }}`, tag)
                        .then(response => {
                ...
                removeTag: function(tag) {
                    ...
                    this.$http.delete("{{ route('search.tags.delete', $search->id) }}/" + tag['id'])
                        .then (function(response) {

...
@section('content-wrapper')
    <div class="content full-page adjacent-center">
        {!! view_render_event('settings.workflows.edit.header.before') !!}
        ...
        {!! view_render_event('settings.workflows.edit.header.after') !!}

        <form method="POST" action="{{ route('settings.workflows.update', $workflow->id) }}" @submit.prevent="onSubmit">
            <div class="page-content">
                <div class="form-container">
                    <div class="panel">
                        <div class="panel-header">
                            {!! view_render_event('settings.workflows.edit.form_buttons.before') !!}

                            <button type="submit" class="btn btn-primary">
                                {{ __('admin::app.settings.workflows.save-btn-title') }}
                            </button>

                            <a href="{{ route('settings.workflows.index') }}">
                                {{ __('admin::app.layouts.back') }}
                            </a>

                            {!! view_render_event('settings.workflows.edit.form_buttons.after') !!}
                        </div>

                        <div class="panel-body workflow-container">
                            {!! view_render_event('settings.workflows.edit.form_controls.before') !!}
                            ...
                            {!! view_render_event('settings.workflows.edit.form_controls.after') !!}
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
    ...
    <script type="text/x-template" id="workflow-component-template">
        ...
        <div>
            ...
            <div class="workflow-panel">
                ...
                <div class="table-container workflow-conditions" style="overflow-x: unset;">
                    <table>
                        <tbody>
            ...
            <div class="workflow-panel">
                ...
                <button type="button" class="btn btn-primary" style="margin-top: 20px;" @click="addAction">
    ...
    <script>
        Vue.component('workflow-component', {
            ...
            data: function() {
                return {
                    events: @json(app('\LeadBrowser\Workflow\Helpers\Entity')->getEvents()),
        ...
        Vue.component('workflow-action-item', {
            ...
            data: function() {
                return {
                    actions: @json(app('\LeadBrowser\Workflow\Helpers\Entity')->getActions()),
                }
            },

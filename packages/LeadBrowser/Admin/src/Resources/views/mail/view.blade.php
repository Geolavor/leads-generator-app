...
@section('content-wrapper')
    ...
    <div class="content full-page">
        ...
        {!! view_render_event('mail.view.header.before', ['email' => $email]) !!}
        ...
        <div class="page-header">
            ...
            <div class="page-action">
                ...
                {!! view_render_event('mail.view.actions.before', ['email' => $email]) !!}

                <email-action-component></email-action-component>

                {!! view_render_event('mail.view.actions.after', ['email' => $email]) !!}
            </div>
        </div>

        {!! view_render_event('mail.view.header.after', ['email' => $email]) !!}


        <div class="page-content" style="margin-top: 30px; padding-bottom: 30px;">

            {!! view_render_event('mail.view.list.before', ['email' => $email]) !!}

            <email-list-component></email-list-component>

            {!! view_render_event('mail.view.list.after', ['email' => $email]) !!}
    ...
    >
        ...
        <modal id="addLeadModal" :is-open="modalIds.addLeadModal">
            ...
            <div slot="header-actions">
                {!! view_render_event('mail.view.actions.leads.create.form_buttons.before', ['email' => $email]) !!}
                ...
                {!! view_render_event('mail.view.actions.leads.create.form_buttons.after', ['email' => $email]) !!}
            </div>

            <div slot="body" style="padding: 0">
                {!! view_render_event('mail.view.actions.leads.create.form_controls.before', ['email' => $email]) !!}
                ...
                <tabs>
                    {!! view_render_event('mail.view.actions.leads.create.form_controls.details.before', ['email' => $email]) !!}
                    ...
                    {!! view_render_event('mail.view.actions.leads.create.form_controls.products.after', ['email' => $email]) !!}
                </tabs>

                {!! view_render_event('mail.view.actions.leads.create.form_controls.after', ['email' => $email]) !!}
            </div>
        </modal>
...
@push('scripts')
    ...
    <script src="{{ asset('vendor/leadBrowser/admin/assets/js/tinyMCE/tinymce.min.js') }}"></script>
        ...
        <div class="email-action-container">
            ...
            <div class="sidebar-filter" :class="{show: show_filter}">
                ...
                <div class="email-action-content">
                    ...
                    <div class="panel">
                        ...
                        <div v-else>
                            <div class="panel-header">
                                ...
                                <span class="links">
                                    <a :href="'{{ route('leads.view') }}/' + email.lead_id" target="_blank">
                                        <i class="icon external-link-icon"></i>
                                    </a>
                    ...
                    {!! view_render_event('mail.view.actions.link_lead.after', ['email' => $email]) !!}
                </div>
            </div>
        </div>
    </script>
                            ...
                            <div class="dropdown-list">
                                <div class="dropdown-container">
                                    <ul>
                                        ...
                                        >
                                            <form :action="'{{ route('mail.delete') }}/' + email.id" method="post" :ref="'form-' + email.id">
                                                @csrf()
            ...
            <div class="email-content">
                ...
                <div class="attachment-list">
                    <div class="attachment-item" v-for='(attachment, index) in email.attachments'>
                        <a :href="'{{ route('mail.attachment_download') }}/' + attachment.id">
        ...
        >
            ...
            <div class="form-container">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        {!! view_render_event('mail.view.email.create.form_controls.before', ['email' => $email]) !!}
                        ...
                        {!! view_render_event('mail.view.email.create.form_controls.after', ['email' => $email]) !!}
                    </div>

                    <div class="panel-bottom">
                        {!! view_render_event('mail.view.email.create.form_buttons.before', ['email' => $email]) !!}
                        ...
                        {!! view_render_event('mail.view.email.create.form_buttons.after', ['email' => $email]) !!}
                    </div>
                </div>

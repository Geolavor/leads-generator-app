...
@section('content-wrapper')
    <div class="content full-page adjacent-center">
        {!! view_render_event('quotes.edit.header.before', ['quote' => $quote]) !!}
        ...
        {!! view_render_event('quotes.edit.header.after', ['quote' => $quote]) !!}

        <form method="POST" action="{{ route('quotes.update', $quote->id) }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
                ...
                <div class="form-container">
                    ...
                    <div class="panel">
                        <div class="panel-header">
                            {!! view_render_event('quotes.edit.form_buttons.before', ['quote' => $quote]) !!}
                            ...
                            {!! view_render_event('quotes.edit.form_buttons.after', ['quote' => $quote]) !!}
                        </div>

                        <div class="panel-body">
                            {!! view_render_event('quotes.edit.form_controls.before', ['quote' => $quote]) !!}

                            @csrf()

                            <input name="_method" type="hidden" value="PUT">

                            {!! view_render_event('quotes.edit.form_controls.information.before', ['quote' => $quote]) !!}

                            <accordian :title="'{{ __('admin::app.quotes.quote-information') }}'" :active="true">
                                <div slot="body">

                                    @include('admin::common.custom-attributes.edit', [
                                        'customAttributes'       => app('LeadBrowser\Attribute\Repositories\AttributeRepository')
                                    ...
                                    <div class="form-group">
                                        ...
                                        @php
                                            $lookUpEntityData = app('LeadBrowser\Attribute\Repositories\AttributeRepository')
                                                ->getLookUpEntity(
                                                    'leads',
                                                    old('lead_id')
                                                        ?: (
                            ...
                            {!! view_render_event('quotes.edit.form_controls.information.after', ['quote' => $quote]) !!}


                            {!! view_render_event('quotes.edit.form_controls.address.before', ['quote' => $quote]) !!}
                            ...
                            {!! view_render_event('quotes.edit.form_controls.address.after', ['quote' => $quote]) !!}


                            {!! view_render_event('quotes.edit.form_controls.items.before', ['quote' => $quote]) !!}
                            ...
                            {!! view_render_event('quotes.edit.form_controls.items.after', ['quote' => $quote]) !!}

                            {!! view_render_event('quotes.edit.form_controls.after', ['quote' => $quote]) !!}
                        </div>
                    </div>
...
@push('scripts')
    <script type="text/x-template" id="quote-item-list-template">
        <div class="quote-item-list">
            ...
            {!! view_render_event('quotes.edit.form_controls.summary.before', ['quote' => $quote]) !!}
            ...
            {!! view_render_event('quotes.edit.form_controls.summary.after', ['quote' => $quote]) !!}
        </div>
    </script>
        ...
        Vue.component('quote-item', {
            ...
            methods: {
                search: debounce(function () {
                    ...
                    this.$http.get("{{ route('products.search') }}", {params: {query: this.product['name']}})

...
namespace LeadBrowser\UI\Http\Controllers;

use Illuminate\Support\Facades\Crypt;
use Illuminate\Support\Str;
use Maatwebsite\Excel\Facades\Excel;
use LeadBrowser\UI\DataGrid\Exports\DataGridExport;
...
class ExportController extends Controller
{
    ...
    public function export()
    {
        ...
        if ($gridInstance instanceof \LeadBrowser\UI\DataGrid\DataGrid) {
         ...
         */
        session()->flash('warning', trans('ui::app.errors.something-went-wrong'));

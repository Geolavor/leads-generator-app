...
class UserDataGrid extends DataGrid
{
    ...
    public function prepareQueryBuilder()
    {
        $queryBuilder = DB::table('users')
            ->addSelect(
                ...
                'users.status',
                'users.created_at',
                // 'wallets.balance as wallet'
            );
            // ->leftJoin('wallets', 'users.id', '=', 'wallets.holder_id')
            // ->where('holder_type', 'LeadBrowser\User\Models\User');
    ...
    public function addColumns()
    {
        ...
        // $this->addColumn([
        //     'index'    => 'wallet',
        //     'label'    => trans('admin::app.datagrid.wallet'),
        //     'type'     => 'string',
        //     'sortable' => true,
        // ]);
    ...
    public function prepareMassActions()
    {
        $this->addMassAction([
            ...
            'action' => route('settings.users.mass_delete'),
            'method' => 'PUT',
        ]);
        ...
        $this->addMassAction([
            ...
            'action'  => route('settings.users.mass_update'),
            'method'  => 'PUT',
            'options' => [

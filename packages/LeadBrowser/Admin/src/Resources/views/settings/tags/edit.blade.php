...
@section('content-wrapper')
    <div class="content full-page adjacent-center">
        {!! view_render_event('settings.tags.edit.header.before') !!}
        ...
        {!! view_render_event('settings.tags.edit.header.after') !!}

        <form action="{{ route('settings.tags.update', $tag->id) }}" method="POST" @submit.prevent="onSubmit">
            <div class="page-content">
                <div class="form-container">
                    <div class="panel">
                        <div class="panel-header">
                            {!! view_render_event('settings.tags.edit.form_buttons.before') !!}
                            ...
                            {!! view_render_event('settings.tags.edit.form_buttons.after') !!}
                        </div>

                        <div class="panel-body tag-container">
                            {!! view_render_event('settings.tags.edit.form_controls.before') !!}
                            ...
                            {!! view_render_event('settings.tags.edit.form_controls.after') !!}
                        </div>
                    </div>
                </div>
            </div>

{!! view_render_event('leads.view.informations.activity_actions.before', ['lead' => $lead]) !!}

<activity-action-component></activity-action-component>

{!! view_render_event('leads.view.informations.activity_actions.after', ['lead' => $lead]) !!}

@push('scripts')

    <script type="text/x-template" id="activity-action-component-template">
        <tabs>
            {!! view_render_event('leads.view.informations.activity_actions.note.before', ['lead' => $lead]) !!}
            ...
            {!! view_render_event('leads.view.informations.activity_actions.note.after', ['lead' => $lead]) !!}


            {!! view_render_event('leads.view.informations.activity_actions.activity.before', ['lead' => $lead]) !!}

            @if (bouncer()->hasPermission('crm.activities.create'))
            ...
            {!! view_render_event('leads.view.informations.activity_actions.activity.after', ['lead' => $lead]) !!}


            {!! view_render_event('leads.view.informations.activity_actions.email.before', ['lead' => $lead]) !!}
            ...
            {!! view_render_event('leads.view.informations.activity_actions.email.after', ['lead' => $lead]) !!}


            {!! view_render_event('leads.view.informations.activity_actions.file.before', ['lead' => $lead]) !!}
            ...
            {!! view_render_event('leads.view.informations.activity_actions.file.after', ['lead' => $lead]) !!}


            {!! view_render_event('leads.view.informations.activity_actions.quote.before', ['lead' => $lead]) !!}

            @if (bouncer()->hasPermission('crm.quotes.create'))
                <tab name="{{ __('admin::app.leads.quote') }}">

                    <a href="{{ route('quotes.create', $lead->id) }}" class="btn btn-primary">{{ __('admin::app.leads.create-quote') }}</a>

                </tab>
            @endif

            {!! view_render_event('leads.view.informations.activity_actions.quote.after', ['lead' => $lead]) !!}
        </tabs>
    </script>
        ...
        Vue.component('activity-action-component', {
            ...
            methods: {
                ...
                search: debounce(function () {
                    ...
                    this.$http.get("{{ route('activities.search_participants') }}", {params: {query: this.search_term}})
                        .then (response => {
                            var self = this;
                ...
                checkIfOverlapping: function(e, formScope) {
                    ...
                    this.$validator.validateAll(formScope).then(function (result) {
                        if (result) {
                            self.$http.post(`{{ route('activities.check_overlapping') }}`, {

...
trait ProvideExceptionHandler
{
     ...
     *
     * @param  array  $column
     * @return void|\LeadBrowser\UI\Exceptions\ConditionKeyException
     */
    public function checkRequiredRowPropertiesKeys($rowProperty)
    {
        $this->checkRequiredKeys($this->requiredRowPropertiesKeys, $rowProperty, function ($missingKeys) {
            ...
            throw new \LeadBrowser\UI\Exceptions\ConditionKeyException($message);
        });
    }
     ...
     *
     * @param  array  $column
     * @return void|\LeadBrowser\UI\Exceptions\ColumnKeyException
     */
    public function checkRequiredColumnKeys($column)
    {
        $this->checkRequiredKeys($this->requiredColumnKeys, $column, function ($missingKeys) {
            ...
            throw new \LeadBrowser\UI\Exceptions\ColumnKeyException($message);
        });
    }
     ...
     *
     * @param  array  $action
     * @return void|\LeadBrowser\UI\Exceptions\ActionKeyException
     */
    public function checkRequiredActionKeys($action)
    {
        $this->checkRequiredKeys($this->requiredActionKeys, $action, function ($missingKeys) {
            ...
            throw new \LeadBrowser\UI\Exceptions\ActionKeyException($message);
        });
    }

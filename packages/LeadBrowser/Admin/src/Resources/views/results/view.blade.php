...
<div class="content full-page">
            ...
            <div class="flex-grow-1 ms-4">
                ...
                data-toggle="tooltip" data-organizationment="top" title="Top profile"> -->
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <span>Website:</span>
                                <a href="{{ $result->organization->website }}" target="_blank">{{ $result->organization->website }}</a>
                            </div>
                            <!-- End Col -->
                            @endif
        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
            ...
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="row align-items-center gx-2">
                        <div class="col">
                            <span class="js-counter display-4 text-dark" data-value="56">{{ $result->organization->count_taxs }}</span>
    ...
    <div class="page-content organization-view">
        ...
        <div class="organization-content-left">
            {!! view_render_event('organizations.view.informations.details.before', ['organization' => $result->organization]) !!}
                        ...
                        <div>
                            <div class="custom-attribute-view">
                                ...
                                <div class="attribute-value-row">
                                    ...
                                    <div class="value">
                                        @include ('admin::common.custom-attributes.view.taxs', ['value' => $result->organization->taxs])
                                    </div>
                                </div>
                                @endif
                                                    ...
                                                    <span>
                                                        <a href="{{ $social['value'] }}" target="_blank">
                                                            <img class="avatar avatar-xss ms-1"
                                                                ...
                                                                alt="Linkedin profile" data-toggle="tooltip" data-placement="top" title="Linkedin profile"
                                                            >
                                                        </a>
                                                    </span>
                                                </div>
                                ...
                                <div class="card card-bordered h-100">
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            <div class="col">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    @if ($result->organization->icon && isset($result->organization->icon))
                                                        <div class="flex-shrink-0">
                                                            <img class="avatar avatar-sm avatar-4x3" src="{{ $result->organization->icon }}" alt="{{ $result->organization->title }}">
                                                        </div>
                                                    @endif

                                                    <div class="flex-grow-1 <?php echo $result->organization->icon ? 'ms-3' : '' ?>">
                                                        <h6 class="card-title">
                                                            <a class="text-dark"
                                            ...
                                            <div class="col-auto">
                                                <form action="{{ route('organizations.buy', ['organization_id' => $result->organization->id]) }}"
                                    ...
                                    <div class="card-footer pt-0" style="border-top: none;">
                                        <ul class="list-inline list-separator small text-body">
                                            ...
                                            <li class="list-inline-item">From {{ $result->organization->city }}, {{ $result->organization->country }}</li>
                                        </ul>

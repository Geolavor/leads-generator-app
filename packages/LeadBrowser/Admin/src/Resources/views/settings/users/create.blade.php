...
@section('content-wrapper')
    <div class="content full-page adjacent-center">
        {!! view_render_event('settings.users.create.header.before') !!}
        ...
        {!! view_render_event('settings.users.create.header.after') !!}

        <form method="POST" action="{{ route('settings.users.store') }}" @submit.prevent="onSubmit">
            <div class="page-content">
                <div class="form-container">

                    <div class="panel">
                        <div class="panel-header">
                            {!! view_render_event('settings.users.create.form_buttons.before') !!}
                            ...
                            {!! view_render_event('settings.users.create.form_buttons.after') !!}
                        </div>

                        <tabs>
                            <tab name="{{ __('admin::app.settings.users.general') }}" :selected="true">
                                {!! view_render_event('settings.users.create.form_controls.general.before') !!}
                                ...
                                {!! view_render_event('settings.users.create.form_controls.general.after') !!}
                            </tab>
    
                            <tab name="{{ __('admin::app.settings.users.permission') }}">
                                {!! view_render_event('settings.users.create.form_controls.permission.before') !!}
                                ...
                                {!! view_render_event('settings.users.create.form_controls.permission.after') !!}
                            </tab>

                            <tab name="{{ __('admin::app.settings.users.payments') }}" :selected="true">
                                {!! view_render_event('settings.users.create.form_controls.payments.before') !!}
                                ...
                                {!! view_render_event('settings.users.create.form_controls.wallet.after') !!}
                            </tab>
                        </tabs>
                    </div>

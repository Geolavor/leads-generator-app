        ...
        <div class="anonymous-layout-container">
            <div class="center-box">
                ...
                <div class="adjacent-center">
                    ...
                    <img class="error-illustraton" src="{{ asset('vendor/leadBrowser/admin/assets/images/error-illustraton.svg') }}">

                    <p>{{ __('Few of the links which may help you to get back on the track -') }}</p>

                    <div class="quick-links">
                        <ul>
                            <li><a href="{{ route('dashboard.index') }}">{{ __('Dashboard') }}</a></li>
                            <li><a href="{{ route('auth.login.create') }}">{{ __('Login') }}</a></li>
                            <li><a href="https://leadBrowser.uvdesk.com">{{ __('Support') }}</a></li>
                            <li><a href="mailto: support@leadBrowsercrm.com">{{ __('Contact LeadBrowser Team') }}</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="copyright">
                        ...
                        <p>© Copyright 2021 <a href="https:leadBrowsercrm.com">LeadBrowser</a>, All right reserved.</p>
                    </div>

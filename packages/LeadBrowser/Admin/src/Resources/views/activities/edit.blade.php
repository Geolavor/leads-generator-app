...
@section('content-wrapper')
    <div class="content full-page adjacent-center">
        {!! view_render_event('activities.edit.header.before', ['activity' => $activity]) !!}
        ...
        {!! view_render_event('activities.edit.header.after', ['activity' => $activity]) !!}

        <form id="form" method="POST" action="{{ route('activities.update', $activity->id) }}" @submit.prevent="onSubmit">
                ...
                <div class="form-container">
                    ...
                    <div class="panel">
                        <div class="panel-header">
                            {!! view_render_event('activities.edit.form_buttons.before', ['activity' => $activity]) !!}

                            <button type="submit" class="btn btn-primary">
                                {{ __('admin::app.activities.save-btn-title') }}
                            </button>

                            <a href="{{ route('activities.index') }}">{{ __('admin::app.activities.back') }}</a>

                            {!! view_render_event('activities.edit.form_buttons.after', ['activity' => $activity]) !!}
                        </div>
        
                        <div class="panel-body">
                            {!! view_render_event('activities.edit.form_controls.before', ['activity' => $activity]) !!}
                            ...
                            <div class="form-group" :class="[errors.has('title') ? 'has-error' : '']">
                                ...
                                <small class="control-error" v-if="errors.has('title')">@{{ errors.first('title') }}</small>
                            </div>
                            ...
                            <div class="form-group" :class="[errors.has('type') ? 'has-error' : '']">
                                ...
                                <small class="control-error" v-if="errors.has('type')">@{{ errors.first('type') }}</small>
                            </div>
                            ...
                            {!! view_render_event('activities.edit.form_controls.after', ['activity' => $activity]) !!}
            ...
            mounted: function() {
                ...
                this.data.forEach(function(participant) {
                    if (participant.user) {
                        ...
                        self.participants.employees.push({'id': participant.employee.id, 'name': participant.employee.name});
                    }
                });
            },
